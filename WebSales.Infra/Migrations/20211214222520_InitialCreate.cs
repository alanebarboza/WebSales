        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarCode = table.Column<string>(type: "nvarchar(43)", maxLength: 43, nullable: true),
            ...
            migrationBuilder.InsertData(
               table: "User",
               columns: new[] { "UserName", "PassWord", "Name", "Gender", "BornDate", "Address", "Email", "InsertedDate", "UpdatedDate" },
               values: new object[,]
               {
                    { "admin",  "?iv??A\u0004\u0015??\b?M?\u0015??g??s?K??\u001fo*?H?\u0018" , "Administrator" , "1", 
                       DateTime.Now.AddDays(-1000), "Street Administrator, Number 123", "admin@admin.com", DateTime.Now, DateTime.Now }
               });
        }
